...
bool rLocalSimulator::Start() {
  ...
  RtestPassengerGenerator * CC_EB_generator = new
  RtestPassengerGenerator(CC_EB_probs, CC_EB_stops_list);
  RtestPassengerGenerator * CC_WB_generator = new
  RtestPassengerGenerator(CC_WB_probs, CC_WB_stops_list);
  RtestPassengerGenerator * CC_SI_generator = new
  RtestPassengerGenerator(CC_SI_probs, CC_SI_stops_list);
  RtestPassengerGenerator * CC_SO_generator = new
  RtestPassengerGenerator(CC_SO_probs, CC_SO_stops_list);
